...
?>                
            ...
            <h3 class="box-title">Timetable - <?php echo isset($row['name']) ? $row['name'] : 'Unknown'; ?></h3>
<?php } ?>
        </div><!-- /.box-header -->
...
?>    
                     <tr id="<?php echo $s_time; ?>_<?php echo $e_time; ?>" >
                        <th  style="color:white; background-color:#666;">
                            <span id="spanSTime_<?php echo isset($row2['id']) ? $row2['id'] : 'N/A'; ?>" data-id="<?php echo $s_time; ?>"><?php echo $s_time; ?></span> - 		
                            <span id="spanETime_<?php echo isset($row2['id']) ? $row2['id'] : 'N/A'; ?>" data-id="<?php echo $e_time; ?>"><?php echo $e_time; ?></span>
                        </th>
